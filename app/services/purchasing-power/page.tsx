...
const service = getServiceBySlug("purchasing-power");
const path = "/services/purchasing-power";

export const metadata: Metadata = pageMetadata({
  title: service?.title ?? "Purchasing Power",
  description: service?.description ?? "",
  path,
});

export default function PurchasingPowerServicePage() {
  if (!service) {
    notFound();
  }
