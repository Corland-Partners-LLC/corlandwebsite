...
const service = getServiceBySlug("leader-development");
const path = "/services/leader-development";

export const metadata: Metadata = pageMetadata({
  title: service?.title ?? "Leader Development",
  description: service?.description ?? "",
  path,
});

export default function LeaderDevelopmentServicePage() {
  if (!service) {
    notFound();
  }
