...
const service = getServiceBySlug("sales-team-training");
const path = "/services/sales-team-training";

export const metadata: Metadata = pageMetadata({
  title: service?.title ?? "Sales Team Training",
  description: service?.description ?? "",
  path,
});

export default function SalesTeamTrainingServicePage() {
  if (!service) {
    notFound();
  }
