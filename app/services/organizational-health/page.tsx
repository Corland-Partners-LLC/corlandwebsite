...
const service = getServiceBySlug("organizational-health");
const path = "/services/organizational-health";

export const metadata: Metadata = pageMetadata({
  title: service?.title ?? "Organizational Health",
  description: service?.description ?? "",
  path,
});

export default function OrganizationalHealthServicePage() {
  if (!service) {
    notFound();
  }
